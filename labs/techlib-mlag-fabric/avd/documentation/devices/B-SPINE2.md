...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.112/24 | 172.100.100.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_B-LEAF1_Ethernet2 | *trunk | *10,20,30 | *- | *- | 1 |
| Ethernet2 | L2_B-LEAF2_Ethernet2 | *trunk | *10,20,30 | *- | *- | 1 |
| Ethernet3 | L2_B-LEAF3_Ethernet2 | *trunk | *10,20,30 | *- | *- | 3 |
| Ethernet4 | L2_B-LEAF4_Ethernet2 | *trunk | *10,20,30 | *- | *- | 3 |
| Ethernet7 | MLAG_B-SPINE1_Ethernet7 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet8 | MLAG_B-SPINE1_Ethernet8 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_A-SPINE1_Ethernet6 | - | 172.16.255.3/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_A-SPINE2_Ethernet6 | - | 172.16.255.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description L2_B-LEAF1_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_B-LEAF2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description L2_B-LEAF3_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description L2_B-LEAF4_Ethernet2
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
!
interface Ethernet7
   description MLAG_B-SPINE1_Ethernet7
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet8
   description MLAG_B-SPINE1_Ethernet8
   no shutdown
   channel-group 1000 mode active
```
...
| Port-Channel1000 | MLAG_B-SPINE1_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_B-SPINE1_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.254.2.2/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan10 |  default  |  10.10.10.5/24  |  -  |  10.10.10.1  |  -  |  -  |
| Vlan20 |  default  |  10.20.20.5/24  |  -  |  10.20.20.1  |  -  |  -  |
| Vlan30 |  default  |  10.30.30.5/24  |  -  |  10.30.30.1  |  -  |  -  |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.254.2.2 | enabled | Vlan4093 <br> Ethernet5 <br> Ethernet6 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
