...
| --------- | --------------- | ------------ | --------- |
| POD1 | Vlan4094 | 169.254.0.0 | Port-Channel1000 |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 10.0.1.2/32 |
| Loopback1 | Unique VTEP IP | default | 10.1.1.1/32 |
| Loopback101 | OISM PIM/IGMP Source | PROD | 10.101.101.2/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.1.2:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.1.2:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart | EVPN Multicast |
| --- | ------------------- | ------------ | ---------------- | -------------- |
| PROD | 10.0.1.2:50001 | connected | - | IPv4: True<br>Transit: False |
