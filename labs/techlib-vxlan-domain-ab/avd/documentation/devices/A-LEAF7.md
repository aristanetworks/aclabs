...
| Ethernet9 | SERVER_HostA8_eth1 | *access | *50 | *- | *- | 9 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_A-SPINE1_Ethernet7 | - | 192.168.0.49/31 | default | 9114 | False | - | - |
| Ethernet2 | P2P_A-SPINE2_Ethernet7 | - | 192.168.0.51/31 | default | 9114 | False | - | - |
| Ethernet3 | P2P_A-SPINE3_Ethernet7 | - | 192.168.0.53/31 | default | 9114 | False | - | - |
| Ethernet4 | P2P_A-SPINE4_Ethernet7 | - | 192.168.0.55/31 | default | 9114 | False | - | - |
| Ethernet7 | P2P_BB1_Ethernet1 | - | 172.16.1.1/31 | default | 9114 | False | - | - |
| Ethernet8 | P2P_BB2_Ethernet1 | - | 172.16.1.5/31 | default | 9114 | False | - | - |
...
!
interface Ethernet9
   description SERVER_HostA8_eth1
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel9 | SERVER_HostA8 | access | 50 | - | - | 90 | static | - | 0000:0000:5746:5831:5333 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel9 | 0000:0000:5746:5831:5333 | all-active | 57:46:58:31:53:33 |
...
interface Port-Channel9
   ...
   evpn ethernet-segment
      identifier 0000:0000:5746:5831:5333
      route-target import 57:46:58:31:53:33
   port-channel lacp fallback static
   port-channel lacp fallback timeout 90
   lacp system-id 5746.5831.5333
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 10.0.1.7/32 |
| Loopback1 | Unique VTEP IP | default | 10.1.1.7/32 |
| Loopback101 | OISM PIM/IGMP Source | PROD | 10.101.101.7/32 |
| Loopback102 | OISM PIM/IGMP Source | DEV | 10.102.102.7/32 |
...
| Loopback1 | Unique VTEP IP | default | - |
| Loopback101 | OISM PIM/IGMP Source | PROD | - |
| Loopback102 | OISM PIM/IGMP Source | DEV | - |
...
!
interface Loopback1
   description Unique VTEP IP
   no shutdown
   ip address 10.1.1.7/32
!
interface Loopback101
   description OISM PIM/IGMP Source
   no shutdown
   vrf PROD
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.0.1 | 65000 | default | - | Inherited from peer group REMOTE-EVPN-PEERS | Inherited from peer group REMOTE-EVPN-PEERS | - | Inherited from peer group REMOTE-EVPN-PEERS | - | - | - | - |
| 10.0.0.2 | 65000 | default | - | Inherited from peer group REMOTE-EVPN-PEERS | Inherited from peer group REMOTE-EVPN-PEERS | - | Inherited from peer group REMOTE-EVPN-PEERS | - | - | - | - |
| 10.0.1.201 | 65100 | default | - | Inherited from peer group LOCAL-EVPN-PEERS | Inherited from peer group LOCAL-EVPN-PEERS | - | Inherited from peer group LOCAL-EVPN-PEERS | - | - | - | - |
| 10.0.1.202 | 65100 | default | - | Inherited from peer group LOCAL-EVPN-PEERS | Inherited from peer group LOCAL-EVPN-PEERS | - | Inherited from peer group LOCAL-EVPN-PEERS | - | - | - | - |
| 10.0.1.203 | 65100 | default | - | Inherited from peer group LOCAL-EVPN-PEERS | Inherited from peer group LOCAL-EVPN-PEERS | - | Inherited from peer group LOCAL-EVPN-PEERS | - | - | - | - |
| 10.0.1.204 | 65100 | default | - | Inherited from peer group LOCAL-EVPN-PEERS | Inherited from peer group LOCAL-EVPN-PEERS | - | Inherited from peer group LOCAL-EVPN-PEERS | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.1.7:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 50 | 10.0.1.7:10050 | 10050:10050 | - | - | learned |
| 70 | 10.0.1.7:10070 | 10070:10070<br>remote 10070:10070 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| DEV | 10.0.1.7:50002 | connected | - |
| PROD | 10.0.1.7:50001 | connected | - |
...
router bgp 65178
   ...
   neighbor LOCAL-EVPN-PEERS peer-tag in SPINES
   neighbor LOCAL-EVPN-PEERS peer-tag out discard SPINES
   neighbor LOCAL-IPV4-PEERS peer group
   neighbor LOCAL-IPV4-PEERS password 7 <removed>
   neighbor LOCAL-IPV4-PEERS send-community
   neighbor LOCAL-IPV4-PEERS maximum-routes 256000
   neighbor LOCAL-IPV4-PEERS peer-tag in SPINES
   neighbor LOCAL-IPV4-PEERS peer-tag out discard SPINES
   ...
   neighbor MLAG-IPV4-PEER maximum-routes 256000
   ...
   neighbor 10.0.0.1 peer group REMOTE-EVPN-PEERS
   neighbor 10.0.0.1 remote-as 65000
   neighbor 10.0.0.1 description BB1
   neighbor 10.0.0.2 peer group REMOTE-EVPN-PEERS
   neighbor 10.0.0.2 remote-as 65000
   neighbor 10.0.0.2 description BB2
   neighbor 10.0.1.201 peer group LOCAL-EVPN-PEERS
   neighbor 10.0.1.201 remote-as 65100
   neighbor 10.0.1.201 description A-SPINE1_Loopback0
   neighbor 10.0.1.202 peer group LOCAL-EVPN-PEERS
   neighbor 10.0.1.202 remote-as 65100
   neighbor 10.0.1.202 description A-SPINE2_Loopback0
   neighbor 10.0.1.203 peer group LOCAL-EVPN-PEERS
   neighbor 10.0.1.203 remote-as 65100
   neighbor 10.0.1.203 description A-SPINE3_Loopback0
   neighbor 10.0.1.204 peer group LOCAL-EVPN-PEERS
   neighbor 10.0.1.204 remote-as 65100
   neighbor 10.0.1.204 description A-SPINE4_Loopback0
   ...
   vlan 10
      rd 10.0.1.7:10010
      rd evpn domain remote 10.0.1.7:10010
   ...
   vlan 70
      rd 10.0.1.7:10070
      rd evpn domain remote 10.0.1.7:10070
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.0.1.7/32 |
| 20 | permit 10.0.1.8/32 |
| 30 | permit 10.1.1.7/32 |
| 40 | permit 10.1.1.8/32 |
...
ip prefix-list PL-GATEWAY-LOOP
   seq 10 permit 10.0.1.7/32
   seq 20 permit 10.0.1.8/32
   seq 30 permit 10.1.1.7/32
   seq 40 permit 10.1.1.8/32
!
