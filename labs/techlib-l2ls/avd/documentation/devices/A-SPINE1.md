...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.11/24 | 172.100.100.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_A-LEAF1_Ethernet1 | *trunk | *10,20,30 | *- | *- | 1 |
| Ethernet2 | L2_A-LEAF2_Ethernet1 | *trunk | *10,20,30 | *- | *- | 1 |
| Ethernet3 | L2_A-LEAF3_Ethernet1 | *trunk | *10,20,30 | *- | *- | 3 |
| Ethernet4 | L2_A-LEAF4_Ethernet1 | *trunk | *10,20,30 | *- | *- | 3 |
| Ethernet7 | MLAG_A-SPINE2_Ethernet7 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet8 | MLAG_A-SPINE2_Ethernet8 | *trunk | *- | *- | *MLAG | 1000 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet5 | P2P_B-SPINE1_Ethernet5 | - | 172.16.255.0/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_B-SPINE2_Ethernet5 | - | 172.16.255.2/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description L2_A-LEAF1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_A-LEAF2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
   description L2_A-LEAF3_Ethernet1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description L2_A-LEAF4_Ethernet1
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
...
!
interface Ethernet7
   description MLAG_A-SPINE2_Ethernet7
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet8
   description MLAG_A-SPINE2_Ethernet8
   no shutdown
   channel-group 1000 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_A-POD1_Port-Channel1 | trunk | 10,20,30 | - | - | - | - | 1 | - |
| Port-Channel3 | L2_A-POD2_Port-Channel1 | trunk | 10,20,30 | - | - | - | - | 3 | - |
| Port-Channel1000 | MLAG_A-SPINE2_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1
   description L2_A-POD1_Port-Channel1
   no shutdown
...
interface Port-Channel3
   description L2_A-POD2_Port-Channel1
   no shutdown
   switchport trunk allowed vlan 10,20,30
   switchport mode trunk
   switchport
...
interface Port-Channel1000
   description MLAG_A-SPINE2_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.254.1.1/32 |
| Loopback1 | Shared VTEP IP | default | 10.255.1.1/32 |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.254.1.1 | enabled | Vlan4093 <br> Ethernet5 <br> Ethernet6 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
