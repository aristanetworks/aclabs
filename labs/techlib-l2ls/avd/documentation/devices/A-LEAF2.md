...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.14/24 | 172.100.100.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_A-SPINE1_Ethernet2 | *trunk | *10,20,30 | *- | *- | 1 |
| Ethernet2 | L2_A-SPINE2_Ethernet2 | *trunk | *10,20,30 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_A-SPINE1_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_A-SPINE2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet5
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_A-SPINES_Port-Channel1 | trunk | 10,20,30 | - | - | - | - | 1 | - |
...
interface Port-Channel1
   description L2_A-SPINES_Port-Channel1
   no shutdown
