...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.31/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| SPINES | Vlan4094 | 10.101.255.0 | Port-Channel21 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.30 vrf MGMT
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 | L2_campus-brdr1_Ethernet50/1 | *trunk | *1000-1001,1110,1120 | *- | *- | 11 |
| Ethernet1/2 | L2_campus-brdr2_Ethernet50/1 | *trunk | *1000-1001,1110,1120 | *- | *- | 11 |
| Ethernet1/3 | L2_campus-leaf1_Ethernet50 | *trunk | *1110,1120 | *- | *- | 13 |
| Ethernet1/4 | L2_campus-leaf2_Ethernet50 | *trunk | *1110,1120 | *- | *- | 13 |
| Ethernet1/5 | L2_campus-leaf3_Ethernet50 | *trunk | *1110,1120 | *- | *- | 15 |
| Ethernet1/6 | L2_campus-leaf4_Ethernet50 | *trunk | *1110,1120 | *- | *- | 15 |
| Ethernet2/1 | MLAG_campus-spine1_Ethernet2/1 | *trunk | *- | *- | *MLAG | 21 |
| Ethernet2/2 | MLAG_campus-spine1_Ethernet2/2 | *trunk | *- | *- | *MLAG | 21 |
...
interface Ethernet1/1
   description L2_campus-brdr1_Ethernet50/1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet1/2
   description L2_campus-brdr2_Ethernet50/1
   no shutdown
   channel-group 11 mode active
!
interface Ethernet1/3
   description L2_campus-leaf1_Ethernet50
   no shutdown
   channel-group 13 mode active
!
interface Ethernet1/4
   description L2_campus-leaf2_Ethernet50
   no shutdown
   channel-group 13 mode active
!
interface Ethernet1/5
   description L2_campus-leaf3_Ethernet50
   no shutdown
   channel-group 15 mode active
!
interface Ethernet1/6
   description L2_campus-leaf4_Ethernet50
   no shutdown
   channel-group 15 mode active
!
interface Ethernet2/1
   description MLAG_campus-spine1_Ethernet2/1
   no shutdown
   channel-group 21 mode active
!
interface Ethernet2/2
   description MLAG_campus-spine1_Ethernet2/2
   no shutdown
   channel-group 21 mode active
```
...
| Port-Channel21 | MLAG_campus-spine1_Port-Channel21 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel21
   description MLAG_campus-spine1_Port-Channel21
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.98.1.130/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan1000 | default | 172.16.254.3/29 | - | 172.16.254.1 | - | - |
| Vlan1001 | default | 172.16.254.11/29 | - | 172.16.254.9 | - | - |
| Vlan1110 | default | 10.10.110.3/24 | - | 10.10.110.1 | - | - |
| Vlan1120 | default | 10.10.120.3/24 | - | 10.10.120.1 | - | - |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 10.98.1.130 | enabled | Vlan4093 | disabled | 12000 | disabled | disabled | - | - | - | - |
