...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.0.32/24 | - |
...
| --------- | --------------- | ------------ | --------- |
| POD1 | Vlan4094 | 10.101.255.1 | Port-Channel51 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet49 | L2_campus-spine1_Ethernet1/3 | *trunk | *1110,1120 | *- | *- | 49 |
| Ethernet50 | L2_campus-spine2_Ethernet1/3 | *trunk | *1110,1120 | *- | *- | 49 |
| Ethernet51 | MLAG_campus-leaf2_Ethernet51 | *trunk | *- | *- | *MLAG | 51 |
| Ethernet52 | MLAG_campus-leaf2_Ethernet52 | *trunk | *- | *- | *MLAG | 51 |
...
interface Ethernet49
   description L2_campus-spine1_Ethernet1/3
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description L2_campus-spine2_Ethernet1/3
   no shutdown
   channel-group 49 mode active
!
interface Ethernet51
   description MLAG_campus-leaf2_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_campus-leaf2_Ethernet52
   no shutdown
   channel-group 51 mode active
```
...
| Port-Channel51 | MLAG_campus-leaf2_Port-Channel51 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel51
   description MLAG_campus-leaf2_Port-Channel51
   no shutdown
   switchport mode trunk
