...
| Ethernet53/1 | L2_dc1-l2leaf1_Ethernet50 | *trunk | *100,102,200 | *- | *- | 531 |
| Ethernet54/1 | L2_dc1-l2leaf2_Ethernet50 | *trunk | *100,102,200 | *- | *- | 531 |
...
interface Ethernet53/1
   description L2_dc1-l2leaf1_Ethernet50
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description L2_dc1-l2leaf2_Ethernet50
   no shutdown
   channel-group 531 mode active
```
...
| Port-Channel531 | L2_DC1_L2LEAF12_Port-Channel49 | trunk | 100,102,200 | - | - | - | - | 531 | - |
...
interface Port-Channel531
   description L2_DC1_L2LEAF12_Port-Channel49
   no shutdown
...
| 102 | 10.99.1.4:10102 | 10102:10102 | - | - | learned |
