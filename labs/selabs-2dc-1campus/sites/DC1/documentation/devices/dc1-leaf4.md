...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet1/6 | - | 10.101.0.21/31 | default | 9214 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet1/6 | - | 10.101.0.23/31 | default | 9214 | False | - | - |
...
interface Ethernet49/1
   description P2P_dc1-spine1_Ethernet1/6
   no shutdown
   mtu 9214
   no switchport
   ip address 10.101.0.21/31
   sflow enable
!
interface Ethernet50/1
   description P2P_dc1-spine2_Ethernet1/6
   no shutdown
   mtu 9214
   no switchport
   ip address 10.101.0.23/31
   sflow enable
!
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.99.1.6/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.101.1.5/32 |
...
| 10.101.0.20 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
| 10.101.0.22 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | True | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.99.1.6:10100 | 10100:10100 | - | - | learned |
| 102 | 10.99.1.6:10102 | 10102:10102 | - | - | learned |
| 200 | 10.99.1.6:10200 | 10200:10200 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| BLUE | 10.99.1.6:501 | connected | - |
| GREEN | 10.99.1.6:502 | connected | - |
...
router bgp 65102
   ...
   neighbor 10.101.0.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.20 remote-as 65000
   neighbor 10.101.0.20 bfd
   neighbor 10.101.0.20 description dc1-spine1_Ethernet1/6
   neighbor 10.101.0.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.22 remote-as 65000
   neighbor 10.101.0.22 bfd
   neighbor 10.101.0.22 description dc1-spine2_Ethernet1/6
