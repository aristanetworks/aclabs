...
| --------- | --------------- | ------------ | --------- |
| DC1_L2LEAF12 | Vlan4094 | 10.101.255.1 | Port-Channel51 |
...
| Ethernet49 | L2_dc1-leaf1_Ethernet53/1 | *trunk | *100,102,200 | *- | *- | 49 |
| Ethernet50 | L2_dc1-leaf2_Ethernet53/1 | *trunk | *100,102,200 | *- | *- | 49 |
| Ethernet51 | MLAG_dc1-l2leaf2_Ethernet51 | *trunk | *- | *- | *MLAG | 51 |
| Ethernet52 | MLAG_dc1-l2leaf2_Ethernet52 | *trunk | *- | *- | *MLAG | 51 |
...
interface Ethernet49
   description L2_dc1-leaf1_Ethernet53/1
   no shutdown
   channel-group 49 mode active
!
interface Ethernet50
   description L2_dc1-leaf2_Ethernet53/1
   no shutdown
   channel-group 49 mode active
!
interface Ethernet51
   description MLAG_dc1-l2leaf2_Ethernet51
   no shutdown
   channel-group 51 mode active
!
interface Ethernet52
   description MLAG_dc1-l2leaf2_Ethernet52
   no shutdown
   channel-group 51 mode active
```
...
| Port-Channel51 | MLAG_dc1-l2leaf2_Port-Channel51 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel51
   description MLAG_dc1-l2leaf2_Port-Channel51
   no shutdown
   switchport mode trunk
