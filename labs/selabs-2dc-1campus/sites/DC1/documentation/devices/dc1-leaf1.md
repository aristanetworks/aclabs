...
| Ethernet53/1 | L2_dc1-l2leaf1_Ethernet49 | *trunk | *100,102,200 | *- | *- | 531 |
| Ethernet54/1 | L2_dc1-l2leaf2_Ethernet49 | *trunk | *100,102,200 | *- | *- | 531 |
...
interface Ethernet53/1
   description L2_dc1-l2leaf1_Ethernet49
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description L2_dc1-l2leaf2_Ethernet49
   no shutdown
   channel-group 531 mode active
```
...
| 102 | 10.99.1.3:10102 | 10102:10102 | - | - | learned |
