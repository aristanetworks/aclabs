...
| --------- | --------------- | ------------ | --------- |
| DC1_BORDER_LEAF1 | Vlan4094 | 10.101.255.1 | Port-Channel511 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.101 vrf MGMT
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet47 | campus-brdr1 | trunk | 1000-1001 | - | - | - |
| Ethernet51/1 | MLAG_dc1-brdr2_Ethernet51/1 | *trunk | *- | *- | *MLAG | 511 |
| Ethernet52/1 | MLAG_dc1-brdr2_Ethernet52/1 | *trunk | *- | *- | *MLAG | 511 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet48 | P2P_dc2-brdr1_Ethernet48 | - | 172.16.255.0/31 | default | 1500 | False | - | - |
...
interface Ethernet48
   description P2P_dc2-brdr1_Ethernet48
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet51/1
   description MLAG_dc1-brdr2_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_dc1-brdr2_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel511 | MLAG_dc1-brdr2_Port-Channel511 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel511
   description MLAG_dc1-brdr2_Port-Channel511
   no shutdown
   switchport mode trunk
...
| Vlan1000 | BLUE | 172.16.254.5/29 | - | 172.16.254.4 | - | - |
| Vlan1001 | GREEN | 172.16.254.13/29 | - | 172.16.254.12 | - | - |
...
| 10.99.2.1 | 64103 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| 172.16.255.1 | 64103 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 100 | 10.99.1.1:10100 | 10100:10100<br>remote 10100:10100 | - | - | learned |
| 102 | 10.99.1.1:10102 | 10102:10102<br>remote 10102:10102 | - | - | learned |
| 200 | 10.99.1.1:10200 | 10200:10200<br>remote 10200:10200 | - | - | learned |
...
router bgp 65103
   ...
   neighbor 10.99.2.1 peer group EVPN-OVERLAY-CORE
   neighbor 10.99.2.1 remote-as 64103
   neighbor 10.99.2.1 description dc2-brdr1
   ...
   neighbor 10.101.254.1 description dc1-brdr2_Vlan4093
   neighbor 172.16.255.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.255.1 remote-as 64103
   neighbor 172.16.255.1 description dc2-brdr1
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 100
      rd 10.99.1.1:10100
      rd evpn domain remote 10.99.1.1:10100
   ...
   vlan 102
      rd 10.99.1.1:10102
      rd evpn domain remote 10.99.1.1:10102
   ...
   vlan 200
      rd 10.99.1.1:10200
      rd evpn domain remote 10.99.1.1:10200
   ...
   vrf BLUE
      ...
      router-id 10.99.1.1
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-brdr2_Vlan3500
   ...
   vrf GREEN
      ...
      router-id 10.99.1.1
      neighbor 10.101.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.101.254.1 description dc1-brdr2_Vlan3501
