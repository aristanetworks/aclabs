...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 1.1.2.23/32 |
| Loopback1 | VTEP IP | default | 2.2.2.23/32 |
| Loopback101 | Unique Loopback for VRF PROD | PROD | 10.101.2.23/32 |
...
| -------- | ----- |
| Instance | 100 |
| Net-ID | 49.1111.0010.0100.2023.00 |
| Type | level-2 |
| Router-ID | 1.1.2.23 |
...
!
router isis 100
   net 49.1111.0010.0100.2023.00
   router-id ipv4 1.1.2.23
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.2.23:10010 | 10010:10010 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart | EVPN Multicast |
| --- | ------------------- | ------------ | ---------------- | -------------- |
| PROD | 1.1.2.23:50001 | connected | - | IPv4: True<br>Transit: False |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.2.23:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 2.2.2.23:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.2.23:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 2.2.2.23:1
```
...
```eos
!
ip address virtual source-nat vrf PROD address 10.101.2.23
```
