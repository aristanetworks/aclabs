...
| Loopback1 | VTEP IP | default | 2.2.1.6/32 |
| Loopback102 | Unique Loopback for VRF DEV | DEV | 10.102.2.6/32 |
...
| -------- | ----- |
| Instance | 100 |
| Net-ID | 49.1111.0010.0100.1006.00 |
| Type | level-2 |
| Router-ID | 1.1.1.6 |
...
!
router isis 100
   net 49.1111.0010.0100.1006.00
   router-id ipv4 1.1.1.6
   is-type level-2
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.1.6:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 2.2.1.6:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.1.6:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 2.2.1.6:1
```
