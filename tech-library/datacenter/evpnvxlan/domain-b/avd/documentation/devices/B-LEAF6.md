...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 1.1.2.26/32 |
| Loopback1 | VTEP IP | default | 2.2.2.26/32 |
| Loopback102 | Unique Loopback for VRF DEV | DEV | 10.102.2.26/32 |
...
| -------- | ----- |
| Instance | 100 |
| Net-ID | 49.1111.0010.0100.2026.00 |
| Type | level-2 |
| Router-ID | 1.1.2.26 |
...
!
router isis 100
   net 49.1111.0010.0100.2026.00
   router-id ipv4 1.1.2.26
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 70 | 1.1.2.26:10070 | 10070:10070 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart | EVPN Multicast |
| --- | ------------------- | ------------ | ---------------- | -------------- |
| DEV | 1.1.2.26:50002 | connected | - | IPv4: True<br>Transit: False |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.2.26:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 2.2.2.26:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.2.26:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 2.2.2.26:1
```
...
```eos
!
ip address virtual source-nat vrf DEV address 10.102.2.26
```
