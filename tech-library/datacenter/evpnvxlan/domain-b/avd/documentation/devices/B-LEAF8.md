...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Globally Unique Address | default | 1.1.2.28/32 |
| Loopback1 | VTEP IP | default | 2.2.2.28/32 |
| Loopback101 | Unique Loopback for VRF PROD | PROD | 10.101.2.28/32 |
| Loopback102 | Unique Loopback for VRF DEV | DEV | 10.102.2.28/32 |
...
interface Loopback101
   ...
   no shutdown
   vrf PROD
   ip address 10.101.2.28/32
!
interface Loopback102
   description Unique Loopback for VRF DEV
   no shutdown
   vrf DEV
   ip address 10.102.2.28/32
```
...
| -------- | ----- |
| Instance | 100 |
| Net-ID | 49.1111.0010.0100.2028.00 |
| Type | level-2 |
| Router-ID | 1.1.2.28 |
...
!
router isis 100
   net 49.1111.0010.0100.2028.00
   router-id ipv4 1.1.2.28
   is-type level-2
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 1.1.2.28:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 20 | 1.1.2.28:10020 | 10020:10020 | - | - | learned |
| 40 | 1.1.2.28:10040 | 10040:10040 | - | - | learned |
| 60 | 1.1.2.28:10060 | 10060:10060<br>remote 10060:10060 | - | - | learned |
| 70 | 1.1.2.28:10070 | 10070:10070<br>remote 10070:10070 | - | - | learned |
| 80 | 1.1.2.28:10080 | 10080:10080<br>remote 10080:10080 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart | EVPN Multicast |
| --- | ------------------- | ------------ | ---------------- | -------------- |
| DEV | 1.1.2.28:50002 | connected | - | IPv4: True<br>Transit: False |
| PROD | 1.1.2.28:50001 | connected | - | IPv4: True<br>Transit: False |
...
router bgp 65200
   ...
   vlan 10
      rd 1.1.2.28:10010
      rd evpn domain remote 1.1.2.28:10010
   ...
   vlan 60
      rd 1.1.2.28:10060
      rd evpn domain remote 1.1.2.28:10060
   ...
   vlan 70
      rd 1.1.2.28:10070
      rd evpn domain remote 1.1.2.28:10070
   ...
   vlan 80
      rd 1.1.2.28:10080
      rd evpn domain remote 1.1.2.28:10080
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.2.28:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 2.2.2.28:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.2.28:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 2.2.2.28:1
```
...
```eos
!
ip address virtual source-nat vrf DEV address 10.102.2.28
ip address virtual source-nat vrf PROD address 10.101.2.28
```
