...
| Loopback1 | VTEP IP | default | 2.2.1.8/32 |
...
| -------- | ----- |
| Instance | 100 |
| Net-ID | 49.1111.0010.0100.1008.00 |
| Type | level-2 |
| Router-ID | 1.1.1.8 |
...
!
router isis 100
   net 49.1111.0010.0100.1008.00
   router-id ipv4 1.1.1.8
   is-type level-2
...
| 20 | 1.1.1.8:10020 | 10020:10020 | - | - | learned |
| 40 | 1.1.1.8:10040 | 10040:10040 | - | - | learned |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 2.2.1.8:1 additive | - | - |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 2.2.1.8:1 additive
```
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 2.2.1.8:1 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 2.2.1.8:1
```
