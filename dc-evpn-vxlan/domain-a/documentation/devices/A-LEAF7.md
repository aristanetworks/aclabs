...
| Loopback101 | Prod_VTEP_DIAGNOSTICS | Prod | 10.255.10.11/32 |
| Loopback102 | Dev_VTEP_DIAGNOSTICS | Dev | 10.255.11.11/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 5 | 10.0.0.11:10005 | 10005:10005<br>remote 10005:10005 | - | - | learned |
...
router bgp 65178
   ...
   vlan 5
      rd 10.0.0.11:10005
      rd evpn domain remote 10.0.0.11:10005
...
```eos
!
ip address virtual source-nat vrf Dev address 10.255.11.11
ip address virtual source-nat vrf Prod address 10.255.10.11
```
