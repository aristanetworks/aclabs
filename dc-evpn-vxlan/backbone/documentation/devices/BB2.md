...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_A-LEAF7_Ethernet8 | routed | - | 172.16.1.3/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_A-LEAF8_Ethernet8 | routed | - | 172.16.1.7/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_B-LEAF7_Ethernet8 | routed | - | 172.16.2.3/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_B-LEAF8_Ethernet8 | routed | - | 172.16.2.7/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_C-LEAF7_Ethernet8 | routed | - | 172.16.3.3/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_C-LEAF8_Ethernet8 | routed | - | 172.16.3.7/31 | default | 9214 | False | - | - |
...
| 172.16.1.8 | 65178 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - |
...
| 172.16.3.8 | 65378 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | Inherited from peer group IPv4-UNDERLAY-PEERS | - |
...
router bgp 65500
   ...
   neighbor 172.16.1.4 description A-LEAF7
   neighbor 172.16.1.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.1.8 remote-as 65178
   neighbor 172.16.1.8 description A-LEAF8
   neighbor 172.16.2.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.2.4 remote-as 65200
   neighbor 172.16.2.4 description B-LEAF7
   neighbor 172.16.2.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.2.8 remote-as 65200
   neighbor 172.16.2.8 description B-LEAF8
   neighbor 172.16.3.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.3.4 remote-as 65378
   neighbor 172.16.3.4 description C-LEAF7
   neighbor 172.16.3.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.3.8 remote-as 65378
   neighbor 172.16.3.8 description C-LEAF8
